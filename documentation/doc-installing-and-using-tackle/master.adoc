...
{project-name} generates a report that describes the difficulty of modifying each application in a project for migration or modernization and recommends the order in which each application shouldd be modified.

You can see this report in the *Report* page of the {project-name} web console.

include::modules/con_about-report.adoc[leveloffset=+2]
